...
import 'package:birthday_app_new/Views/InvitationCards/Anniversaryinvitation.dart';
...
class BirthdayInvitation extends StatefulWidget {
  const BirthdayInvitation({Key? key}) : super(key: key);

  @override
  State<BirthdayInvitation> createState() => _BirthdayInvitationState();
}

class _BirthdayInvitationState extends State<BirthdayInvitation> {
  List<dynamic> data = [];
  List<InvitationSubCategoryModel> subcards = [];
  @override
  initState() {
    Constants.SubCategoryurl =
        "http://134.209.195.127/api/index.php?all=yes&keys=Birthday_App/invitation_Cards/Birthday_Invitation";
  ...
  getads() {
    ...
    applicationBloc.birthdaypageabnner();
  }
    ...
    return Scaffold(
              ...
              children: [
                ...
                outlinedchip(
                  ...
                  ontap: () async {
                    ...
                    if (result == true) {
                      Get.off(() => const Anniversaryinvitation());
                    } else {
                      EasyLoading.dismiss();
        ...
        Consumer<get_ads>(
          builder: (context, data, child) {
            return Container(
              color: data.isbirthdaypagebanner
                  ? Colors.white
                  : Colors.yellow[200],
              width: double.infinity,
              height: Constants.screenHeight(context) * 0.06,
              child: data.isbirthdaypagebanner == true
                  ? AdWidget(ad: data.birthday_page_banner)
                  : Row(
